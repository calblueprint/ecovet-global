...
const SearchBar: React.FC<{ filterMode: "all" | "your" | "browse" }> = ({
  filterMode,
}) => {
  ...
  useEffect(() => {
    const loadTemplates = async () => {
      ...
      let subsetTemplates = allTemplates;

      if (filterMode === "all") {
        subsetTemplates = allTemplates.filter(
          t =>
            t.accessible_to_all === true || t.user_group_id === user_group_id,
        );
      } else if (filterMode === "your") {
        subsetTemplates = allTemplates.filter(
          t => t.user_group_id === user_group_id,
        );
      } else if (filterMode === "browse") {
        subsetTemplates = allTemplates.filter(
          t => t.accessible_to_all === true,
        );
      }
